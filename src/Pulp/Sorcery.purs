...
foreign import sorceryImpl :: EffFn4 PulpEffects (StrMap { map :: String, baseDir :: String }) String (EffN Unit) (EffN Unit) Unit

-- | Run sorcery, given map of JS filename -> sourcemap text, and JS file
sorcery :: StrMap { map :: String, baseDir :: String } -> String -> AffN Unit
